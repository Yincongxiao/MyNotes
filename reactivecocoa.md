...
> _所以，你可能听说过reactivecocoa被描述为函数响应式编程\(_[**\*\***](https://en.wikipedia.org/wiki/Functional_reactive_programming)[_FRP_](https://en.wikipedia.org/wiki/Functional_reactive_programming)[**\*\***](https://en.wikipedia.org/wiki/Functional_reactive_programming)_）框架。
> 其他平台上也有类似的框架例如java的__****RXJava****__ swift中的\_\__\*\*\_ReactiveSwif_\*\*
